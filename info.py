...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001813259061')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Team_XDs')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Team_XDs')
